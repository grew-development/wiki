...
## Price + Shop-Link
2,75€ (+VAT)<br/>
<a href="https://store.grew-development.de/package/5453979" target="_blank">To the store</a>
...
## License
This script is licensed under Grew Development Network Script License. For more information, please refer to the [LICENSE-file](/grew_npc/license).
