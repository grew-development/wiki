...
## License
This script is licensed under the Mozilla Public License Version 2.0. For more information, please refer to the [LICENSE-file](/grew_versionchecker/license).
