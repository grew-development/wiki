...
## Price + Shop-Link
3,00€ (+VAT)<br/>
<a href="https://store.grew-development.de/package/5454068" target="_blank">To the store</a>
...
## License
This script is licensed under Grew Development Network Script License. For more information, please refer to the [LICENSE-file](/grew_esxaddon/license).
